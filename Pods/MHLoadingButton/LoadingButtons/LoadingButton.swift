...
open class LoadingButton: UIButton {
     ...
     */
    @IBInspectable public var bgColor: UIColor = .clear {
        didSet {
    ...
    public init(
        ...
        self.setBackgroundImage(UIImage(.clear), for: .disabled)
...
extension UIActivityIndicatorView: IndicatorProtocol {
    ...
    public var color: UIColor {
        ...
        set {
            ...
            #if os(iOS)
			self.style = newValue.RGBtoCMYK(red: ciColor.red, green: ciColor.green, blue: ciColor.blue).key > 0.5 ? .white : .white
            #endif
